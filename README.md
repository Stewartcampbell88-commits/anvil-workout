...
| `sw.js` | Offline service worker (`anvil-v16` cache) |
...
When you change shell assets (HTML/CSS/JS), bump the service worker `CACHE` name (currently `anvil-v16`) so installed clients fetch the new files.
