...
| `sw.js` | Offline service worker (`anvil-v6` cache) |
...
When you change shell assets (HTML/CSS/JS), bump the service worker `CACHE` name (currently `anvil-v6`) so installed clients fetch the new files.
