...
| `sw.js` | Offline service worker (`anvil-v4` cache) |
...
When you change shell assets (HTML/CSS/JS), bump the service worker `CACHE` name (currently `anvil-v4`) so installed clients fetch the new files.
