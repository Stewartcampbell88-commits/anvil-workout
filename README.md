...
| `sw.js` | Offline service worker (`anvil-v18` cache) |
...
When you change shell assets (HTML/CSS/JS), bump the service worker `CACHE` name (currently `anvil-v18`) so installed clients fetch the new files.
